      ...
      <section className={styles.userProfileSection}>
        <div className={styles.userProfileBlock}>
          <div className={styles.userProfileBlockContent}>
            ...
            <p>Вам доступен список пройденных тестов с результатами, а также все взаимодействия с ними</p>
        ...
        <div className={styles.userProfileBlock}>
          <div className={styles.userProfileBlockContent}>
            ...
            <p>В личном кабинете в разделе “Мои тесты” вам доступны статистические данные по вашим авторским тестам</p>
            <ContrastButton type={'link'} label={'Войти'} inversed={false} />
          </div>
        </div>
      </section>
      <section className={styles.contactUsSection}>
        <div className={styles.contactUsContent}>
          ...
          <form className={styles.contactUsForm} action='#'>
            <textarea name='contact-us' id='contact-us-textarea' placeholder='Напишите нам' defaultValue='' />
