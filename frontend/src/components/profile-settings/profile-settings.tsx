    ...
    <main className={styles.pageMain}>
      ...
      <form className={styles.contentForm} action='#' name='create-test-form'>
        ...
        <fieldset className={`${styles.contentArea} ${styles.shortAbstractForm}`}>
          <label>О себе</label>
          <textarea id='bio' name='bio' value={formData.userBio} onChange={handleOnFormChange} />
        </fieldset>
        <fieldset className={styles.testLogo}>
          <label>Аватар</label>
          <div className={`${styles.dropZone} ${formData.userAvatar && styles.active}`}>
        ...
        <div className={styles.controls}>
          <button className={styles.createButton} onSubmit={handleSubmit}>
            Сохранить
          </button>
        </div>
      </form>
