...
urlpatterns = [
    ...
    path('tests/', NewTestAPIView.as_view(), name='tests'),   # get, post
    path('test/<int:test_pk>/', NewTestAPIView.as_view()),   # get
    path('update_test/<int:test_pk>/', NewTestAPIView.as_view()),  # put, delete
