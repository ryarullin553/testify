    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feedbacks_count', models.IntegerField(default=0, verbose_name='Количество отзывов')),
                ('results_count', models.IntegerField(default=0, verbose_name='Количество результатов')),
                ('avg_score', models.DecimalField(decimal_places=1, default=0, max_digits=10, verbose_name='Средний результат')),
                ('avg_answers_count', models.DecimalField(decimal_places=1, default=0, max_digits=10, verbose_name='Среднее количество ответов')),
                ('avg_correct_answers_count', models.DecimalField(decimal_places=1, default=0, max_digits=10, verbose_name='Среднее количество правильных ответов')),
            ],
            options={
                'verbose_name': 'Тест',
